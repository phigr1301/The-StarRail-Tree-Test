...
function resetRow(row) {
	if (prompt('Are you sure you want to reset this row? It is highly recommended that you wait until the end of your current run before doing this! Type "All time is gone. All thing is gone. All things cannot save." to confirm') !="All time is gone. All thing is gone. All things cannot save") return
...
function hardReset(resetOptions) {
	...
	if (!confirm("Are you SURE you want to do this? You will lose all your progress!")) return
	if (!confirm("Are you REALLY SURE you want to do this? You will lose all your progress!")) return
	player = null
